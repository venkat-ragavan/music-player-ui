...
internal class AllPodcastAdapter(private var podcastList: List<Podcast>, val row: OnPodcastSelectListener) :
    RecyclerView.Adapter<AllPodcastAdapter.MyViewHolder>() {
